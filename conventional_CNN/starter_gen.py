...
from Keras_CNN_gen import Xception_derived_model, data_processing 
...
#steps_per_epoch = 8
validation_steps = 2020
#validation_steps = 2
x_train = np.load('data/train-npy/npdatasetX0.npy')
print "x-train", x_train.shape
y_train = np.load('data/train-npy/npdatasetY0.npy')
...
WriteDictToCSV('history4.csv', history.history.keys(), history.history)

# Save the model
model.save("complete_model4.h5")
